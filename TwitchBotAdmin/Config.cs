...
namespace TwitchBot
{
    ...
    {
        private static string _oath2_ClientId = null;
        public static string ClientId
        {
            get
            {
                if (_oath2_ClientId == null)
                    _oath2_ClientId = ConfigurationManager.AppSettings["TwitchBotAdmin.OAuth2.ClientId"];
                return _oath2_ClientId;
            }
        }

        private static string _oath2_ClientSecret = null;
        public static string ClientSecret
        {
            get
            {
                if (_oath2_ClientSecret == null)
                    _oath2_ClientSecret = ConfigurationManager.AppSettings["TwitchBotAdmin.OAuth2.ClientSecret"];
                return _oath2_ClientSecret;
            }
        }
